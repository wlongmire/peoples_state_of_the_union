// Based on Clay.io DOMless canvas input
// Generated by CoffeeScript 1.3.3
// Modified by Graham Batzler
...
(function() {
  var CanvasInput, Events,
	...
	var calculateOffset = function(e, context) {
		var pos = {};
		if(e.offsetX==undefined) { // this works for Firefox
		    pos.x = e.pageX-$(context.canvas).offset().left;
		    pos.y = e.pageY-$(context.canvas).offset().top;
...
//       }
	  this.defaultBackgroundColor = options.backgroundColor || "#ffffff";
    ...
    CanvasInput.prototype.click = function(e) {
      var pos = calculateOffset(e, this);
      if (this.inBox(pos.x, pos.y)) {
        return this.focus();
      } else {
        return this.unfocus();
      }
    ...
    CanvasInput.prototype.refresh = function() {
      ...
      // focus gradient
      // this.backgroundGradient = this.ctx.createLinearGradient(this.xPos, this.yPos, this.xPos, this.yPos + this.height);
//       this.backgroundGradient.addColorStop(0, "#eeeeee");
// 	  this.backgroundGradient.addColorStop(1, "#ffffff");
      ...
      this.ctx.fillStyle = this.focused ? this.backgroundGradient : this.defaultBackgroundColor;
  ...
  this.CanvasText = (function(_super) {
    ...
    CanvasText.prototype.mouseMove = function(e) {
      var pos = calculateOffset(e, this);
      if (this.inBox(pos.x, pos.y) && this.canvas.style) {
