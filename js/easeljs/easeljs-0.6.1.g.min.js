...
(function () {
    ...
    b.prependTransform = function (a, b, g, d, e, f, h, k, j) {
        if (e % 360) {
            ...
            e = Math.cos(l);
            l = Math.sin(l)
        } else e = 1, l = 0; if (k || j) this.tx -= k, this.ty -= j;
...
(function () {
    ...
    a.decodePath = function (a) {
        for (var g = [this.moveTo, this.lineTo, this.quadraticCurveTo, this.bezierCurveTo,
            this.closePath
        ], d = [2, 2, 4, 6, 0], c = 0, f = a.length, h = [], k = 0, j = 0, l = b.BASE_64; c < f;) {
            var n = a.charAt(c),
                q = l[n],
                p = q >> 3,
                s = g[p];
        ...
        for (var k = this.children.length - 1; 0 <= k; k--) {
            ...
            if (j.visible && !(!l && !j.isVisible() || d && !j.mouseEnabled)) {
                ...
                if (j instanceof c && (!l || !n))
                    ...
                    if (j.getConcatenatedMatrix(f), l && (f.appendTransform(l.x, l.y, l.scaleX, l.scaleY, l.rotation, l.skewX, l.skewY, l.regX, l.regY), f.alpha = l.alpha), e.globalAlpha =
